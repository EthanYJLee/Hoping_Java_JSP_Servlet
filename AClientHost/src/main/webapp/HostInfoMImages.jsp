...
<%@ include file = "hnav1.jsp" %>
 ...
 <div class="container myscontainer">
 	...
 	<div class="row myscontainer">
	 	<form class="card col-4" style="border: 0px"  action = "hiddenImgUp.jsp?link=image1Up.do" method = "post" enctype = "multipart/form-data">
			<input type = "file" name = "file" size = "50" />
			<input type="hidden">
			<input type = "submit" value = "Upload" size="50" />
		</form>
	 	<form class="card col-4" style="border: 0px"  action = "hiddenImgUp.jsp?link=image2Up.do" method = "post" enctype = "multipart/form-data">
			<input type = "file" name = "file" size = "50" />
			<input type="hidden">
			<input type = "submit" value = "Upload" size="50" />
		</form>
	 	<form class="card col-4" style="border: 0px"  action = "hiddenImgUp.jsp?link=image3Up.do" method = "post" enctype = "multipart/form-data">
			<input type = "file" name = "file" size = "50" />
			<input type="hidden">
			<input type = "submit" value = "Upload" size="50" />
		</form>
