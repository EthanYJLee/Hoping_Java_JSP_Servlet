...
<body>
	...
	<div class="container">
		...
		<form name="myform" id="myform" method="get" action="reviewWrite.do">
		<input type="hidden" name="regSeq" value="${DetailView.regSeq}">
		<input type="hidden" name="host_hSeq" value="${DetailView.host_hSeq}">
			...
			<table>
				...
				<tr>
					<th>작성자</th>
					<td><input type="text" name="rvCName" size="50" value="${reviewer.rvCName}"></td>
				</tr>
